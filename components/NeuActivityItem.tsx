...
export const NeuActivityItem: React.FC<ActivityItemProps> = ({ user, action, target, time, icon, className = '' }) => {
return (
...
<span className="font-bold text-gray-800">{user.name}</span> {action} {target && <span className="font-bold text-gray-800"> {target}</span>}
</p>
