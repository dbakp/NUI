...
export const NeuAgendaItem: React.FC<AgendaItemProps> = ({ 
    time, 
    title, 
    presenter, 
    duration, 
        ...
        <div className={`flex gap-4 group ${className}`}>
            ...
            <div className="relative flex flex-col items-center">
                <div className={`
                    ...
                    ${isCompleted 
                        ? 'bg-neu-accent border-neu-accent' 
                        : 'bg-neu-base border-gray-300 shadow-neu-convex'}
                `}>
            ...
            <div className={`
                ...
                ${isCompleted 
                    ...
                    : 'bg-neu-base shadow-neu-flat hover:shadow-neu-convex hover:-translate-y-1'}
            `}>
