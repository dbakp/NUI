...
export const NeuCalendar: React.FC<CalendarProps> = ({ 
        ...
        <button
          ...
          className={`
            ...
            ${isSelected 
              ...
              : isToday 
                ? 'shadow-neu-convex text-neu-accent font-bold border border-neu-accent/20'
  ...
  return (
    <div className={`p-6 rounded-[2rem] bg-neu-base shadow-neu-flat border border-white/20 w-fit ${className}`}>
      <div className="flex items-center justify-between mb-6">
        <button 
          onClick={handlePrevMonth}
          className="w-8 h-8 rounded-full flex items-center justify-center shadow-neu-flat hover:shadow-neu-pressed active:translate-y-px text-gray-500"
        >
          <ChevronLeft size={16} />
        </button>
