...
export const NeuCapacityGauge: React.FC<CapacityGaugeProps> = ({ current, max, label = "Occupancy", className = '' }) => {
...
{/* Gauge Fill */}
<div className="absolute top-0 left-0 w-32 h-32 rounded-full border-[12px] border-transparent transition-transform duration-1000 ease-out origin-bottom"
...
{/* Actually, a simpler CSS approach for semi-circle progress usually involves rotating a covered half. Let's use an SVG for precision in neumorphism context. */}
</div>
