...
export const NeuComment: React.FC<CommentProps> = ({ 
    author, 
    avatar, 
    date, 
    content, 
    ...
    return (
        <div className={`flex gap-4 group ${className}`}>
            ...
            <div className="flex-1">
                ...
                <div className="
                    p-3 rounded-tr-2xl rounded-br-2xl rounded-bl-2xl bg-neu-base 
                    shadow-neu-flat border border-white/20 text-sm text-gray-600 leading-relaxed
                ">
                    {content}
                </div>
                ...
                {onDelete && (
                    <div className="mt-1 flex justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                         <button 
                            onClick={onDelete}
                            className="text-xs text-neu-danger hover:underline flex items-center gap-1"
                         >
