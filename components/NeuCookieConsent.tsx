...
export const NeuCookieConsent: React.FC<CookieConsentProps> = ({ 
    isOpen, 
    onAccept, 
    onDecline, 
    className = '' 
    ...
    return (
        ...
        `}>
            <div className="
                pointer-events-auto
                bg-neu-base/90 backdrop-blur-md shadow-[0_-10px_40px_rgba(0,0,0,0.1)] 
                border border-white/20 rounded-3xl p-6 md:p-8
                max-w-4xl w-full flex flex-col md:flex-row items-center gap-6 md:gap-8
                animate-in slide-in-from-bottom-10 duration-500
            ">
                <div className="
                    w-16 h-16 rounded-2xl bg-neu-base shadow-neu-convex 
                    flex items-center justify-center text-neu-warning flex-shrink-0
                ">
                    <Cookie size={32} />
                </div>
