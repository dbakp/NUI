...
export const NeuDialog: React.FC<DialogProps> = ({ 
    isOpen, 
    onClose, 
    title, 
    children, 
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            {/* Backdrop */}
            <div 
                className="absolute inset-0 bg-neu-base/60 backdrop-blur-sm transition-opacity" 
                onClick={onClose}
            />
            
            {/* Dialog Content */}
            <div className="
                relative w-full max-w-lg bg-neu-base rounded-3xl shadow-neu-flat p-8 
