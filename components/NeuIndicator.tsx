...
return (
<div className="relative rounded-full flex items-center justify-center bg-gray-100"
style={{ width: size, height: size }}
>
<div className="absolute inset-0 rounded-full m-2 flex items-center justify-center">
