...
export const NeuMetricCard: React.FC<MetricCardProps> = ({ title, value, trend, icon, className = '',
chartPath
}) => {
return (
...
<div className={`
flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-bold border border-white/10
${trend.isPositive ? 'text-emerald-500 bg-emerald-500/5' : 'text-red-500 bg-red-500/5'}
`}>
