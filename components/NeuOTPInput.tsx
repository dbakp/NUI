...
export const NeuOTPInput: React.FC<OTPInputProps> = ({ length = 6, onChange, className = '' }) => {
...
onPaste={handlePaste}
className="w-full h-full text-center text-xl font-bold bg-transparent border-none outline-none text-gray-700
focus:ring-0
"
/>
{/* Focus Glow */}
