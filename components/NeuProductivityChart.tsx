...
export const NeuProductivityChart: React.FC<ProductivityChartProps> = ({ current, goal, label = "Daily Goal", className = '' }) => {
...
{isGoalMet ? (
<Trophy size={24} className="text-emerald-500 mb-1" fill="currentColor" />
) : (
...
{isGoalMet && <span className="text-[10px] text-emerald-500 font-bold mt-1">Goal Reached!</span>}
</div>
);
};