...
export const NeuRadioGroup: React.FC<RadioGroupProps> = ({ 
  options, 
  value, 
  onChange, 
  name, 
            ...
            return (
                ...
                >
                    <div className={`
                        ...
                        ${isChecked 
                            ? 'shadow-neu-pressed' 
                            : 'shadow-neu-flat bg-neu-base group-hover:shadow-neu-pressed-sm'}
                    `}>
                        <div className={`
                            w-2.5 h-2.5 rounded-full transition-all duration-300
                            ${isChecked ? 'bg-neu-accent scale-100 shadow-[0_0_5px_rgba(108,99,255,0.6)]' : 'bg-transparent scale-0'}
                        `} />
                    </div>
