...
export const NeuReviewCard: React.FC<ReviewCardProps> = ({ 
    author, 
    avatar, 
    rating, 
    date, 
    ...
    return (
        <div className={`
            p-6 rounded-3xl bg-neu-base shadow-neu-flat border border-white/20
        ...
        `}>
            <div className="flex justify-between items-start">
                ...
                <div className="bg-neu-base/50 p-2 rounded-xl shadow-neu-pressed">
