...
export const NeuSlider: React.FC<SliderProps> = ({ min, max, value, onChange,
label
}) => {
...
<div className="absolute h-5 w-5 rounded-full bg-gray-100 pointer-events-none transition-all duration-75 flex items-center justify-center
