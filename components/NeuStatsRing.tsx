...
export const NeuStatsRing: React.FC<StatsRingProps> = ({ 
    rings, 
    size = 200, 
    className = '' 
}) => {
    ...
    return (
        <div className={`relative flex items-center justify-center ${className}`} style={{ width: size, height: size }}>
            ...
            <div className="absolute inset-0 rounded-full shadow-neu-pressed bg-neu-base" />
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                 <div className="flex flex-col gap-1 items-center bg-neu-base/80 backdrop-blur-sm p-2 rounded-xl shadow-neu-convex">
                     {rings.map((ring, i) => (
