...
export const NeuVisitorBadge: React.FC<VisitorPassProps> = ({ 
    visitorName, 
    company, 
    hostName, 
    date, 
    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <div className="
                relative z-10 w-full max-w-[280px] bg-neu-base rounded-[20px] 
                shadow-neu-convex border border-white/20 p-6 text-center flex flex-col gap-4 overflow-hidden
            ">
                {/* Punch Hole Visual */}
                <div className="absolute top-4 left-1/2 -translate-x-1/2 w-12 h-3 rounded-full bg-neu-base shadow-neu-pressed"></div>
                ...
                <div className="mt-6">
                    ...
                    {company && <p className="text-sm font-semibold text-neu-accent mt-1">{company}</p>}
                </div>
                ...
                <div className="mt-2 flex justify-center">
                    <div className="p-3 bg-white rounded-xl shadow-neu-pressed border border-white/50">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-2 bg-neu-accent opacity-50"></div>
            </div>
        </div>
    );
};